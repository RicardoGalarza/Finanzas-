...
const REMEMBERED_EMAIL_KEY = 'flujoclaro_remembered_email'
...
export function LoginPage() {
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    try {
      ...
      localStorage.setItem(REMEMBERED_EMAIL_KEY, values.email.trim().toLowerCase())
  ...
  return (
    <div className="auth-layout">
      <form className="auth-card stack" onSubmit={onSubmit} autoComplete="on">
        <div>
